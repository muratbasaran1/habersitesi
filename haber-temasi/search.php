...
?>
<div class="page-screen page-screen--search">
    <div class="page-shell">
        <header class="page-header-block">
            <div class="page-header-block__titles">
                <h1 class="page-header-block__title"><?php printf( esc_html__( '“%s” araması', 'haber-sitesi' ), esc_html( $search_query ) ); ?></h1>
                <div class="page-header-block__description">
                    <?php esc_html_e( 'Anahtar kelimenizle ilgili en güncel başlıkları listeliyoruz.', 'haber-sitesi' ); ?>
                </div>
            </div>
            <div class="page-header-block__meta">
                <span class="page-badge">
                    <?php
                    printf(
                        _n( '%s sonuç bulundu', '%s sonuç listelendi', $total_posts, 'haber-sitesi' ),
            ...
            <div class="page-layout__main">
                ...
                <?php else : ?>
                    <div class="page-empty">
                        <p><?php esc_html_e( 'Eşleşen sonuç bulunamadı.', 'haber-sitesi' ); ?></p>
                        <p><?php esc_html_e( 'Farklı anahtar kelimeler deneyebilir veya manşetlere göz atabilirsiniz.', 'haber-sitesi' ); ?></p>
                    </div>
                <?php endif; ?>
            </div>
            <aside class="page-layout__sidebar" aria-label="<?php esc_attr_e( 'Yan sütun', 'haber-sitesi' ); ?>">
                <?php if ( ! empty( $sidebar_trending ) ) : ?>
                    <section class="page-card page-card--trending">
                        <div class="page-card__header">
                            ...
                            <p class="page-card__subtitle"><?php esc_html_e( 'Son saatlerin en çok ziyaret edilen başlıkları', 'haber-sitesi' ); ?></p>
                        </div>
                ...
                <?php if ( ! empty( $sidebar_categories ) ) : ?>
                    <section class="page-card page-card--categories">
                        <div class="page-card__header">
                            <h2 class="page-card__title"><?php esc_html_e( 'Gündem Başlıkları', 'haber-sitesi' ); ?></h2>
                            <p class="page-card__subtitle"><?php esc_html_e( 'Hızlı erişim için popüler kategoriler', 'haber-sitesi' ); ?></p>
                        </div>
                ...
                <section class="page-card page-card--newsletter">
                    <div class="page-card__header">
                        <h2 class="page-card__title"><?php esc_html_e( 'Anlık Bildirimler', 'haber-sitesi' ); ?></h2>
                        <p class="page-card__subtitle"><?php esc_html_e( 'Kırmızı alarm haberlerini ve önemli gelişmeleri kaçırmayın.', 'haber-sitesi' ); ?></p>
                    </div>
                    <form class="page-newsletter" action="<?php echo esc_url( home_url( '/bulten' ) ); ?>" method="get">
                        <label class="screen-reader-text" for="search-newsletter-email"><?php esc_html_e( 'E-posta adresiniz', 'haber-sitesi' ); ?></label>
                        <input id="search-newsletter-email" class="page-newsletter__field" type="email" name="email" placeholder="<?php echo esc_attr__( 'ornek@haber.com', 'haber-sitesi' ); ?>" required>
                        <button class="page-newsletter__button" type="submit"><?php esc_html_e( 'Beni haberdar et', 'haber-sitesi' ); ?></button>
                    </form>
                </section>
            </aside>
        </div>
